...
kill -9 "$pid"
nohup /home/ubuntu/.sdkman/candidates/java/current/bin/java -DLOGS_FOLDER=$MEETUP_BOT_PROD_PATH/logs -jar $MEETUP_BOT_BIN_PATH/$MEETUP_BOT_JAR_NAME --spring.profiles.active=prod,prod-db-h2-ubuntu >/dev/null 2>&1 &
