...
public class User implements Serializable {
  ...
  public static User fromTelegramUser(org.telegram.telegrambots.meta.api.objects.User telegramUser) {
    return User.builder()
        ...
        .canConnectToBusiness(telegramUser.getCanConnectToBusiness())
        .hasMainWebApp(telegramUser.getHasMainWebApp())
        .hasTopicsEnabled(telegramUser.getHasTopicsEnabled())
        .allowsUsersToCreateTopics(telegramUser.getAllowsUsersToCreateTopics())
  ...
  public org.telegram.telegrambots.meta.api.objects.User toTelegramUser() {
    return new org.telegram.telegrambots.meta.api.objects.User(
        ...
        this.getCanConnectToBusiness(),
        this.getHasMainWebApp(),
        this.getHasTopicsEnabled(),
        this.getAllowsUsersToCreateTopics()
    );
  }
  ...
  public User updateFieldsFromTelegramUser(org.telegram.telegrambots.meta.api.objects.User telegramUser) {
    ...
    this.setCanConnectToBusiness(telegramUser.getCanConnectToBusiness());
    this.setHasMainWebApp(telegramUser.getHasMainWebApp());
    this.setHasTopicsEnabled(telegramUser.getHasTopicsEnabled());
    this.setAllowsUsersToCreateTopics(telegramUser.getAllowsUsersToCreateTopics());
